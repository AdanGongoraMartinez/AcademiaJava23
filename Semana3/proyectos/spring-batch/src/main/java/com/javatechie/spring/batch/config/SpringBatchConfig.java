...
import com.javatechie.spring.batch.repository.RepositorioCliente;
...
public class SpringBatchConfig {
    ...
    private LineMapper<Cliente> lineMapper() {
        ...
        lineTokenizer.setNames("id", "nombre", "apellido", "email", "genero", "noContacto", "pais", "fdn");
    ...
    @Bean
    public ClienteProcesador processor() {
        return new ClienteProcesador();
    }
